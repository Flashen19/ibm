...
public class MojeOkienko extends JFrame implements ActionListener //implements ActionListener - implementujemy do klasy okienka, ¿eby przyciski czeka³y na znak
{
	...
	JLabel lWyswietlDate; //definiujemy wyswietlacz 
	public MojeOkienko () //konstruktor okienka
	{
		...
		bPodajDate = new JButton("Podaj datê"); // tworzymy przciesk (action sourse)
		...
		bWyjscie.addActionListener(this); // dodajemy czujnik action
	
		lWyswietlDate = new JLabel ("Data");
		lWyswietlDate.setBounds(150,150,250, 150);
		lWyswietlDate.setForeground(new Color (245, 34, 77));
		add(lWyswietlDate);
	}
